    ...
    public class vCardStandardReader : vCardReader
    {
        ...
        public vCardProperty ReadProperty(TextReader reader)
        {
            ...
            do
            {
                ...
                {
                    Warnings.Add(DWall.VCards.WarningMessages.BlankLine);
                    continue;
                }
                ...
                if (colonIndex == -1)
                {
                    Warnings.Add(DWall.VCards.WarningMessages.ColonMissing);
                    continue;
                }
                ...
                {
                    Warnings.Add(DWall.VCards.WarningMessages.EmptyName);
                    continue;
                }
                ...
                for (int index = 1; index < nameParts.Length; index++)
                {
                    ...
                    if (subNameValue.Length == 1)
                    {
                        ...
                        if (string.IsNullOrEmpty(name))
                        {
                            Warnings.Add(DWall.VCards.WarningMessages.EmptySubProperty);
                        }
                        else
                        {
